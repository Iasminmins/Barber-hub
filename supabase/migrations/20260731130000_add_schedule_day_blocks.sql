...
create index if not exists idx_schedule_blocks_barbershop_date
on public.schedule_blocks (barbershop_id, date);
...
begin
  if exists (
    ...
    raise exception 'A agenda deste barbeiro está bloqueada neste dia.';
  end if;
  return new;
end;
$$;

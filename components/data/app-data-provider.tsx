  ...
  const load = React.useCallback(async () => {
    ...
    setValue({
      barbershops: (shops ?? []).map((item) => ({
        ...
        publicBookingSettings: { ...defaultPublicBookingSettings, ...(item.public_booking_settings ?? {}), cashback: { ...defaultPublicBookingSettings.cashback, ...(item.public_booking_settings?.cashback ?? {}) } },
      })),
      barbershop: {
        id: shopId,

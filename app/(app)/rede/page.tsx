...
import { ArrowRight, Building2, CalendarDays, CheckCircle2, Crown, MapPin, Plus, Store, Wallet } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <Dialog open={dialogOpen} onClose={() => !saving && setDialogOpen(false)}>
        <DialogHeader title="Adicionar unidade" description={`Seu Premium permite até ${unitLimit} unidades. A nova barbearia terá operação e dados separados.`} />
